...
import refreshIcon from "url:../../main/img/refresh-outline.svg";
  ...
  generateMarkup(data) {
    ...
    <div class="memory-container grid--memory-app">
      <button class="memory-close-btn" aria-label="Close memory app">
        <img class="close-memory-app" src="${closeIcon}" alt="close button" />
      </button>
      <button class="memory-new-btn" aria-label="Start new game">
        <img class="refresh-memory-app" src="${refreshIcon}" alt="new game button" />
      </button>
